...
\label{fig4}
\end{figure}
從Fig. 3和Fig. 4得知，3-hidden layer和5-hidden layer的MSE彼此差不多且都無overfitting的現象，但是 5-hidden layer在第40個epoch後MSE突然上下起伏，觀察Fig. 3 cost也在這個時候有同一個現象，很有可能是在這時的learning rate太高所導致。
